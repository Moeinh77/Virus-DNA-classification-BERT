...
I used the **Weights and Biases** library for logging the reuslts of the training and as shown below in only 2 epochs the model reaches an f1 score of 0.99. 
